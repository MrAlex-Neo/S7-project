...
const CircleAnimation = ({step, kw }) => {
      ...
      Animated.loop(
        Animated.sequence([
          Animated.timing(animation, {
            toValue: 35, // Максимальное значение elevation
            duration: 1000,
            easing: easeInOut,
  ...
  return (
    <Animated.View
      className="justify-center items-center rounded-full mx-auto mt-[5vh] shadow-2xl"
      style={{
        shadowColor: color,
    ...
    >
      <Animated.View
        className="justify-center items-center rounded-full mx-auto shadow-2xl"
        style={{
          shadowColor: color,
          elevation: animation, // Это важно для Android
          overflow: "visible", // чтобы тень отображалась за пределами границ
      ...
      >
        ...
        >
          <Animated.View
            className={`items-center border-4 mx-auto px-[15vw] py-[12vw]  shadow-2xl`}
            style={{
              alignItems: "center",
              borderColor: color,
          ...
          >
            ...
            <Text className="font-semibold text-3xl">{kw}кВт</Text>
            <Text className="font-robotoRegular text-base">Энергия</Text>
          </Animated.View>
        </Animated.View>
      </Animated.View>
    </Animated.View>
